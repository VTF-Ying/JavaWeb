...
public class SerletDemo07 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      // 2. 设置响应头支持的类型
        ...
        *  attchment;filename=2.png  消息头参数 附件形式进行处理   指定下载文件名称
        * */
        resp.setHeader("Content-Type","application/octet-stream");
       // 3. 设置响应头以下载方式打开附件

        resp.setHeader("Content-Disposition","attchment;filename=2.png");
